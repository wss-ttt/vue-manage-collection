    ...
    <div class="demo-ruleForm login-container">
      ...
      >
        ...
        <el-form-item prop="account">
          <el-input
            type="text"
            @focus="img2=true;img1=false;img3=false;"
            @blur="img1=true;img2=false;"
        ...
        <el-form-item prop="checkPass">
          <el-input
            type="password"
            @focus="img3=true;img1=false;img2=false;"
            @blur="img1=true;img3=false;"
        ...
        <el-row type="flex" style="margin-bottom:22px;" class="row-bg" justify="space-between">
          ...
          <el-col :span="4">
            <el-button @click="flag=false" type="text" style="padding:0;">用户注册</el-button>
          </el-col>
        </el-row>
      ...
      >
        ...
        <el-row type="flex" style="margin-bottom:22px;" class="row-bg" justify="space-between">
          ...
          <el-col :span="8">
            <el-button @click="flag=true" type="text" style="padding:0;">使用已有账户登录</el-button>
          </el-col>
        </el-row>
        <el-form-item style="width:100%;">
          <el-button
    ...
    handleregister() {
      ...
      this.$refs.ruleForm3.validate(valid => {
        if (valid) {
          this.logining = true
          var loginParams = {
            username: this.ruleForm3.account,
            password: this.ruleForm3.checkPass
          }
          api
            .addreg(loginParams)
            .then(function(response) {
